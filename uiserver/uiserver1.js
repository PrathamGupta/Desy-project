...
app.post('/addAdmissionCriteria', urlencodedParser, async function (req, res) {
    try {
        ...
        let chaincodeName = "index.js"
        // Get the network (channel) our contract is deployed to.
        const network = await gateway.getNetwork(channelName);

        const contract = network.getContract(chaincodeName);

        await contract.submitTransaction('admCriteria', req.body.instituteId, req.body.instituteName, req.body.stream, req.body.maxSeatCount, req.body.minimumAge, req.body.minimumRankExam, req.body.minimumBoardPercentage, req.body.extras);
